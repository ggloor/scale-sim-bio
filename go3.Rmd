...
The final problem is that these data are relative data, i.e. compositional [@lovell:2011;@Quinn:2019aa], 
...
Varying amounts of scale uncertainty is incorporated using the \texttt{gamma} parameter that controls the amount uncertainty added to the CLR mean assumption when we call either \texttt{aldex()}, or \texttt{aldex.clr()}.
